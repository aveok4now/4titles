...
const getGlobeConfig = (theme: string | undefined): COBEOptions => ({
    width: 800,
    height: 800,
    onRender: () => {},
    devicePixelRatio: 2,
    ...
    diffuse: 0.4,
    mapSamples: 16000,
    mapBrightness: theme === 'dark' ? 0.8 : 1.2,
    baseColor: theme === 'dark' ? [0.1, 0.1, 0.1] : [1, 1, 1],
    markerColor: theme === 'dark' ? [0.8, 0.8, 0.8] : [0.2, 0.2, 0.2],
    glowColor: theme === 'dark' ? [0.2, 0.2, 0.2] : [0.8, 0.8, 0.8],
    markers: [
...
export function Globe({
    ...
    const globeConfig = useMemo(() => getGlobeConfig(theme), [theme])
    let phi = 0
    let width = 0
